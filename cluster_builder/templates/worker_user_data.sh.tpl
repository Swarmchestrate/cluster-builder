...
if systemctl is-active --quiet k3s-agent; then
    ...
    if ! curl -sfL https://get.k3s.io | sh -s - agent --node-external-ip="${public_ip}" --node-name="${resource_name}" --node-label="labels.swarmchestrate.eu/ms_id=${resource_name}"; then
